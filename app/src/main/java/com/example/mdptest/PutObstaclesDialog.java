...
public class PutObstaclesDialog extends DialogFragment {
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        setObstacleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getTargetFragment() instanceof SecondFragment) {
                    ((SecondFragment) getTargetFragment()).applyValues(aValue, xValue, yValue);
                }
